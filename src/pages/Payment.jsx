...
let email,name1,phone1,BookedDate1,TotalAmount1,registration1,vehicle1,id1,ToTime1,FromTime1,BookingDate1;
const Payment = (props) => {
...
useEffect(() => {
  ...
  .then((data)=>{
    ...
    const fetchDestinations = async () => {
      const url='https://myparkingsolutions-default-rtdb.firebaseio.com//booking-history'
  ...
  return(
    <div>
      ...
      <Card>
       ...
       <h4>Booked Slot: {FromTime1}:00 - {ToTime1}:00  (Time Displayed in 24 hours Format)</h4>
      ...
      <Pdf targetRef={ref} filename="Parking Receipt.pdf" options={options} x={.5} y={.5} scale={1}>
        {({ toPdf }) => <button className={classes.print} onClick={toPdf}>Download Booking Receipt</button>}
      </Pdf>
